...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.evi = await MockBEP20.deployed();
        ...
        await this.evi.transfer(bob, '2000', { from: minter });
        await this.evi.transfer(alice, '2000', { from: minter });
        await this.evi.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.evi.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.evi.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.evi.balanceOf(this.lotteryProxyAddress)).toString(), '418');
